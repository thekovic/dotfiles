...
.Example
dir c:\dforce | New-IsoFile -Path .\dforce.iso -Title DFORCE -Media CDR -Verbose -Force
This commands creates a .iso file that contains content of the "c:\dforce" folder, has title "DFORCE", and has media type of CD-R (important to be able to read the disc on MS-DOS).
